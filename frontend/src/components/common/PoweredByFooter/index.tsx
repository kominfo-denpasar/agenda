    ...
    const footerContent = isHiEvents() ? (
        <>
            ...
            <a href="#!https://hi.events?utm_source=app-powered-by-footer&utm_content=try-hi-events-free"
               ...
               title={''}>
                {t`Pemerintah Kota Denpasar`} - {t`Crafted By SPBE Kominfos & Hi.Events`}
            </a>
        </>
    ) : (
        <>
            {' '}
            <a href="https://denpasarkota.go.id"
               target="_blank"
               title={'Official Website of Denpasar City Government'}>
                Pemerintah Kota Denpasar
            </a> {'|'} {t`Crafted By SPBE Kominfos & Hi.Events`}
        </>
    );
